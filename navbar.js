...
(function () {
  ...
  style.textContent = `
    ...
    .sdd-logo { display:flex; align-items:center; gap:10px; text-decoration:none; color:#0f172a; }
    .sdd-logo h2 { font-size:1.2rem; font-weight:900; letter-spacing:-0.02em; margin:0; }
    .sdd-logo .text-primary { color:#002d62; }
    ...
    .sdd-tab:hover, .sdd-tab.sdd-active-tab {
      background: #eef2ff; color: #002d62;
    }
    .sdd-tab.sdd-page-active { color: #002d62; font-weight: 700; }
    .sdd-chevron {
      width: 14px; height: 14px; flex-shrink: 0;
      transition: transform 0.2s ease;
      color: #94a3b8;
    }
    .sdd-tab.sdd-active-tab .sdd-chevron { transform: rotate(180deg); color: #002d62; }
    ...
    /* Section label */
    .sdd-section-label {
      font-size: 0.75rem; font-weight: 600; color: #002d62;
      text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 8px;
    }
    /* Links inside dropdown */
    .sdd-link {
      display: block; font-size: 0.85rem; color: #475569;
      text-decoration: none; padding: 3px 0;
      transition: color 0.12s;
    }
    .sdd-link:hover { color: #002d62; }
    ...
    .sdd-blog-title { font-size: 0.82rem; font-weight: 600; color: #0f172a; line-height: 1.3; margin-bottom: 3px; transition: color 0.12s; }
    .sdd-blog-card:hover .sdd-blog-title { color: #002d62; }
    ...
    .sdd-cta {
      ...
      background: #002d62; color: #fff; font-size: 0.85rem; font-weight: 700;
      text-decoration: none; white-space: nowrap; flex-shrink: 0;
      transition: background 0.15s, transform 0.15s;
    }
    .sdd-cta:hover { background: #0a48c9; transform: scale(1.02); }
    ...
    #sdd-mobile-menu a, #sdd-mobile-menu button.sdd-mobile-tab {
      ...
      color: #475569; text-decoration: none; background: none; border: none;
      cursor: pointer; font-family: 'Inter', sans-serif; width: 100%;
      transition: background 0.12s, color 0.12s;
    }
    #sdd-mobile-menu a:hover, #sdd-mobile-menu button.sdd-mobile-tab:hover { background: #e0e7ff; color: #002d62; }
    #sdd-mobile-menu a.sdd-page-active { color: #002d62; font-weight: 700; }
    .sdd-mobile-sub {
      display: none; flex-direction: column; gap: 2px;
      padding: 6px 12px 6px 24px;
      border-left: 2px solid #002d62; margin: 0 12px 4px;
    }
    ...
    .sdd-mobile-cta {
      ...
      background: #002d62; color: #fff !important; font-weight: 700 !important;
      text-align: center;
    }
