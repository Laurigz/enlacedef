...
(function () {
  ...
  // Standard logo for light navbar
  const LOGO_SVG = `<img class="h-12 w-auto object-contain" style="height: 3rem;" src="/logo-enlace.png" alt="Enlace Agencia Digital Logo" />`;
  ...
  style.textContent = `
    ...
    .sdd-tab.sdd-page-active { color: #18181b; font-weight: 600; }
    .sdd-chevron {
    ...
    .sdd-link {
      display: block; font-size: 0.875rem; font-weight: 500; color: #64748b;
      text-decoration: none; padding: 4px 0;
      transition: color 0.15s;
    }
    .sdd-link:hover { color: #0f172a; }

    /* "View more" CTA */
    .sdd-view-more {
      display: flex; align-items: center; gap: 4px;
      margin-top: 16px; padding-top: 16px; border-top: 1px solid #f4f4f5; 
    ...
    .sdd-blog-title { font-size: 0.875rem; font-weight: 500; color: #18181b; line-height: 1.3; margin: 0 0 4px 0; transition: color 0.15s; text-decoration: underline; text-underline-offset: 4px; text-decoration-color: #d4d4d8; }
    .sdd-blog-card:hover .sdd-blog-title { color: #000000; text-decoration-color: #000000; }
    .sdd-blog-desc { font-size: 0.75rem; color: #71717a; line-height: 1.4; margin: 0; }

    /* CTA button */
    .sdd-cta {
      display: flex; align-items: center; justify-content: center;
      padding: 10px 24px; border-radius: 9999px;
      background: #18181b; color: #ffffff; font-size: 0.875rem; font-weight: 600;
      text-decoration: none; white-space: nowrap; flex-shrink: 0;
      transition: all 0.15s;
    }
    .sdd-cta:hover { background: #27272a; box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1); transform: scale(1.02); }
    ...
    #sdd-mobile-btn:hover { background: rgba(0, 0, 0, 0.05); }
    ...
    #sdd-mobile-menu a, #sdd-mobile-menu button.sdd-mobile-tab {
      ...
      color: #52525b; text-decoration: none; background: none; border: none;
      cursor: pointer; font-family: 'Inter', sans-serif; width: 100%;
      transition: background 0.15s;
    }
    #sdd-mobile-menu a:hover, #sdd-mobile-menu button.sdd-mobile-tab:hover { background: #f4f4f5; color: #18181b; }
    #sdd-mobile-menu a.sdd-page-active { font-weight: 600; color: #18181b; }
    
    .sdd-mobile-sub {
      display: none; flex-direction: column; gap: 4px;
      padding: 4px 16px 4px 24px;
      border-left: 2px solid #e4e4e7; margin: 0 16px 8px;
    }
    .sdd-mobile-sub.open { display: flex; }
    .sdd-mobile-sub a { padding: 8px; font-size: 0.875rem; border-radius: 6px; color: #71717a; }
    .sdd-mobile-sub a:hover { color: #18181b; }
